...
drought_event{3,1}=[datenum([2011 12 1]) datenum([2020 07 01])]; % First and last date of each drought event
...
% Third drought event 
drought_event{3,2}(1,:)=[2011 12 01];
drought_event{3,2}(2,:)=[2012 8 01];
drought_event{3,2}(3,:)=[2013 8 01];
drought_event{3,2}(4,:)=[2014 06 01];
drought_event{3,2}(6,:)=[2016 06 01];
drought_event{3,2}(8,:)=[2018 09 01];
drought_event{3,2}(9,:)=[2019 09 01];
drought_event{3,2}(10,:)=[2020 06 01];
...
titulo{3,1}='2012-2019 Drought Event';
close all
for k=1:3
