...
* From the DEM, compute the area of the upsream sub-catchment relative to each reservoir in that sub-catchment
* Compute D~x~ for each reservoir by dividing their upstream area by the total area
