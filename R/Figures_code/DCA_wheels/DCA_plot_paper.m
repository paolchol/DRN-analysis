...
drought_event{2,2}(4,:)=[2002 05 01];
% Third drought event 
drought_event{3,2}(1,:)=[2010 12 01];
drought_event{3,2}(2,:)=[2011 11 01];
drought_event{3,2}(3,:)=[2014 07 01];
...
esphbe=0.025;
esphbd=0.025;
nt=20; %Numero de tons
nc=1; %Numero de cores por quadrante
...
[X,Y,COR] = plot_droughwheel(3.2, cq1,cq2,cq3,cq4,200,nc); % Create the DCA color wheel
% Basic configuration of the subplot
nplotx=1;
nploty=1;
espvbi=0.000;
