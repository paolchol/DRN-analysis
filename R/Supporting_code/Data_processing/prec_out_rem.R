...
#Rodrigues, D. T. et al.
# Spatial distribution of the level of return of extreme precipitation events
# in Northeast Brazil. (2020), doi:10.1002/joc.6507.
#So:
# - Stations with exceptionally high outliers have been completely removed from
#     the dataframe, considering them not reliable
# - Singular observations above this threshold have been removed
#     from the dataframe
