...
path_export <- "./Inputs/Model_input/MEs/1_Time_series_update/intermediate"
...
temp_f <- fill_na(temp_f, skipcol = 2)
hum_f <- fill_na(hum_f, skipcol = 2)
rad_f <- fill_na(rad_f, skipcol = 2)
