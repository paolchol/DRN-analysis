...
INTEGER :: j,g  !i,h,id,ih,irout,imun,dummy1
real:: dummy2


real :: shear_bed,d50 !manning_sed,shear_sec,accum1,accum2
real :: hidexp(n_sed_class) !hidp(n_sed_class),expp(n_sed_class),
