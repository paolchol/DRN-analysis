SUBROUTINE readgen(path2do_dat)
    ...
    if (trim(path2do_dat)=='') then
        path2do_dat='C:/Thesis_fortran/Directory_WASA_Banabuiu/Input/do.dat'    !Till: use default, if no command line argument was specified
        custompath='C:/Thesis_fortran/Directory_WASA_Banabuiu'
    else
