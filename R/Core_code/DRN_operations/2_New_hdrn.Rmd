...
```{r}
writeOGR(glob_wat_cut, dsn = "./Global_surface_water", layer = "global_wat_cut",
...
DRN_update <- readOGR(dsn = "./DRN/DRN_update_area_ID.shp")
```
...
path<-"C:/Users/Utente/OneDrive - Politecnico di Milano/Backup PC/Uni/Thesis/Data/DRN/DRN_afterR_v2.shp"
...
count_class<-read.table(paste0(path, "/lake_number_newDRN_met2.dat"), skip = 2)
...
```{r lake_number}
path<-"C:/Users/Utente/OneDrive - Politecnico di Milano/Backup PC/Uni/Thesis/Analysis/gen_files"
my.write(count_class,file=paste0(path,"/lake_number_newDRN_met2.dat"),
...
path<-"C:/Users/Utente/OneDrive - Politecnico di Milano/Backup PC/Uni/Thesis/Analysis/gen_files"
my.write(round(median_class,2),file=paste0(path,"/lake_maxvol_newDRN_m2_median.dat"),
...
options(scipen = 999)
path<-"C:/Users/Utente/OneDrive - Politecnico di Milano/Backup PC/Uni/Thesis/Analysis/gen_files"
my.write(par_class,file=paste0(path,"/lake_noDRN.dat"),
         header = "Specification of parameters for the reservoir size classes\nReservoir_class-ID, maxlake0[m**3], lake_vol0_factor[-], lake_change[-], alpha_Molle[-], damk_Molle[-], damc_hrr[-], damd_hrr[-]",f = write.table)
options(scipen = 0)
```
...
#No reservoirs
path<-"C:/Users/Utente/OneDrive - Politecnico di Milano/Backup PC/Uni/Thesis/Analysis/gen_files"
write.table("Specification of total number of reservoirs in the size classes\nSub-basin-ID, acud[-] (five reservoir size classes)",paste0(path,"/lake_number_noDRN_v1.dat"), row.names = FALSE, quote = FALSE, col.names = FALSE)

#Only one resevoir in the smallest reservoir class
count_class[,2]<-1
count_class[,3:6]<-0
my.write(count_class,file=paste0(path,"/lake_number_noDRN_v2.dat"),
         header = "Specification of total number of reservoirs in the size classes\nSub-basin-ID, acud[-] (five reservoir size classes)",f = write.table)
...
count_class[,2]<-0
count_class[,3:6]<-0
my.write(count_class,file=paste0(path,"/lake_number_noDRN_v3.dat"),
         header = "Specification of total number of reservoirs in the size classes\nSub-basin-ID, acud[-] (five reservoir size classes)",f = write.table)
